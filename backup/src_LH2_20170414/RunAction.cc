...
/////////////////////////////////////////////////
{
  ...
  // TFile* file = new TFile("rootfiles/proton_LH2_phi54.root",
  // 			  "RECREATE", "Geant4 ROOT analysis");
  // TFile* file = new TFile("rootfiles/proton_LH2_phi80.root",
  // 			  "RECREATE", "Geant4 ROOT analysis");
  // TFile* file = new TFile("rootfiles/proton_LH2_phi27.root",
  //  			  "RECREATE", "Geant4 ROOT analysis");
  // TFile* file = new TFile("rootfiles/proton_LH2_phi40.root",
  //  			  "RECREATE", "Geant4 ROOT analysis");

  // TFile* file = new TFile("rootfiles/pion_LH2_phi54.root",
  //  			  "RECREATE", "Geant4 ROOT analysis");
  // TFile* file = new TFile("rootfiles/pion_LH2_phi80.root",
  //  			  "RECREATE", "Geant4 ROOT analysis");
  // TFile* file = new TFile("rootfiles/pion_LH2_phi27.root",
  //   			  "RECREATE", "Geant4 ROOT analysis");
  TFile* file = new TFile("rootfiles/pion_LH2_phi40.root",
    			  "RECREATE", "Geant4 ROOT analysis");
